...
CLevelDBWrapper::CLevelDBWrapper(const boost::filesystem::path& path, size_t nCacheSize, bool &isObfuscated, bool fMemory, bool fWipe, bool compression, int maxOpenFiles)
{
    penv = NULL;
